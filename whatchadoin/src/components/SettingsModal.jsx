...
import { Settings, Copy, DatabaseBackup, Import } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      {settingsTab === 'sync' && (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(255, 255, 255, 0.05)', padding: '12px 16px', borderRadius: '8px', border: '1px solid var(--panel-border)' }}>
          ...
          <div>
            <label style={{ fontSize: '12px', color: 'var(--text-secondary)', display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
              ...
              <a href="https://github.com/settings/tokens/new?scopes=gist&description=whatchadoin+Sync" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 'bold' }}>Create Token &rarr;</a>
            </label>
            <input 
              type="password" 
              placeholder="ghp_..." 
          ...
          <div>
            <label style={{ fontSize: '12px', color: 'var(--text-secondary)', display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
              <span>Gist ID</span>
              <a href="https://gist.github.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 'bold' }}>Create Gist &rarr;</a>
            </label>
            <input 
              type="text" 
